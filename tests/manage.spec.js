...
test.describe('Manage teleport integration ', () => {
    test.skip('To verify that the every service toggle btn on when clicking the add video all toggle btn ON',
        async () => {
    ...
    test('To verify that every service toggle btn off, when clicking the add video all toogle btn OFF',
        async () => {
            await integration.integrationModuleClick()
            await teleport.teleportClick()
            await manage.manageClick()

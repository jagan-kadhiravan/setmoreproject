...
export class Instagram {
    ...
    async toCheckInstaStreamingHeading() {
        expect(await this.instaStreamingHeading).toContainText('Instagram Streaming')
    }
    ...
    async toClickCloseIcon() {
        await this.page.waitForSelector('[class="ml-3"]+[class="nostyle close-btn"]')
    ...
    async loginInstagram(){
        //await expect.soft(this.page).toHaveUrl(instaLogin.url)
    ...
    async clickConnectAndSwitchToNewWindow() {
        ...
        const page1 = await page1Promise
         ...
         //await expect(this.loginInstaUsername).toBeVisible();
        ...
        // await this.page.waitForSelector('[class="nostyle close-btn"]')
        // await this.page.locator('[class="nostyle close-btn"]').click()

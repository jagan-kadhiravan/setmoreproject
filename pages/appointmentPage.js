...
export class Service {
    constructor(page) {
        ...
        this.fifteenMin = page.locator(
            "#scheduleId_10f1a8de-54a5-4c25-b281-fba11d84eb1b"
        );
        this.thirtyMin = page.locator(
            "#scheduleId_97d96ac8-63ed-4a41-a88a-1c05ab7f0a78"
        );
        ...
        this.stateClick = page.locator(
            '[data-testid="state-bar"] [id="g-input state"]'
        );
    ...
    async selectTimeClick() {
        ...
        await expect(
            this.page.locator(
                '[data-testid="app-widget-start-time-list"] [data-testid="app-widget-start-' +
                t +
                '"]'
            )
        ).toHaveText(t);
